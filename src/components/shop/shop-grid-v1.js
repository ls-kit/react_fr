...
class ShopGridV1 extends Component {
  render() {
    ...
    return (
      <div>
        <div className='le__product-area le__product-gutter mb-100'>
          <div className='container'>
            <div className='row'>
              <div className='col-lg-12'>
                <div className='le__shop-options'>
                  <ul>
                    <li>
                      <div className='le__grid-list-tab-menu '>
                        <div className='nav'>
                ...
                <div className='tab-content '>
                  <div className='tab-pane fade active show' id='liton_product_grid'>
                    <div className='le__product-tab-content-inner le__product-grid-view'>
                      <div className='row'>
                        <div className='col-lg-12'>
                          {/* Search Widget */}
                          <div className='le__search-widget mb-30'>
                            <form action='#'>
                  ...
                  <div className='tab-pane fade' id='liton_product_list'>
                    <div className='le__product-tab-content-inner le__product-list-view'>
                      <div className='row'>
                        <div className='col-lg-12'>
                          {/* Search Widget */}
                          <div className='le__search-widget mb-30'>
                        ...
                        {/* le__product-item */}
                        <div className='col-lg-12'>
                          <div className='le__product-item le__product-item-4 le__product-item-5'>
                            <div className='product-img'>
                              <Link to='/product-details'>
                                <img src={publicUrl + "assets/img/product-3/1.jpg"} alt='#' />
                              </Link>
                      ...
                      <div className='row'>
                        <div className='col-12'>
                          ...
                          <div className='additional-info d-none'>
                            <p>
                              We want to give you <b>10% discount</b> for your first order, <br /> Use
