...
class ShopDetails extends Component {
  render() {
    ...
    return (
      <div className='le__shop-details-area pb-10'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-8 col-md-12'>
              <div className='le__shop-details-inner le__page-details-inner mb-60'>
                ...
                <label>
                  <span className='le__secondary-color'>
                ...
                <p>
                  ...
                  mauris cursus mattis molestee iaculis at erat pellentesque. Id interdum velit laoreet id
                  donec ultrices tincidunt.
                </p>
                <p>
                  To the left is the modern kitchen with central island, leading through to the unique
                  breakfast family room which feature glass walls and doors out onto the garden and access to
                ...
                <div className='le__property-details-gallery mb-30'>
                  <div className='row'>
                ...
                <div className='le__apartments-plan-area product-details-apartments-plan mb-60'>
                  <div className='le__tab-menu le__tab-menu-3 le__tab-menu-top-right-- text-uppercase--- text-center---'>
                    <div className='nav'>
                  ...
                  <div className='tab-content'>
                    <div className='tab-pane fade' id='liton_tab_3_1'>
                      <div className='le__apartments-tab-content-inner'>
                        <div className='row'>
                          ...
                          <div className='col-lg-5'>
                            <div className='apartments-plan-info le__secondary-bg--- text-color-white---'>
                              <h2>First Floor</h2>
                              <p>
                                Enimad minim veniam quis nostrud exercitation ullamco laboris. Lorem ipsum
                                dolor sit amet cons aetetur adipisicing elit sedo eiusmod tempor.Incididunt
                                labore et dolore magna aliqua. sed ayd minim veniam.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className='tab-pane fade active show' id='liton_tab_3_2'>
                      <div className='le__product-tab-content-inner'>
                        <div className='row'>
                          <div className='col-lg-7'>
                            <div className='apartments-plan-img'>
                              <img src={publicUrl + "assets/img/others/10.png"} alt='#' />
                ...
                <div
                  className='le__video-bg-img le__video-popup-height-500 bg-overlay-black-50 bg-image mb-60'
                ...
                <div className='le__shop-details-tab-content-inner--- le__shop-details-tab-inner-2 le__product-details-review-inner mb-60'>
                  ...
                  <hr />
                  {/* comment-area */}
                  <div className='le__comment-area mb-30'>
                    <div className='le__comment-inner'>
                      <ul>
                        <li>
                          <div className='le__comment-item clearfix'>
                            <div className='le__commenter-img'>
                              <img src={publicUrl + "assets/img/testimonial/1.jpg"} alt='Image' />
                            </div>
                            <div className='le__commenter-comment'>
                              <h6>
                                <a href='#'>Adam Smit</a>
                              </h6>
                              <div className='product-ratting'>
                              ...
                              <p>
                                ...
                                fugit corporis iste magnam ratione.
                              </p>
                              <span className='le__comment-reply-btn'>September 3, 2020</span>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div className='le__comment-item clearfix'>
                            ...
                            <div className='le__commenter-comment'>
                              ...
                              <span className='le__comment-reply-btn'>September 2, 2020</span>
                            </div>
                          </div>
                        </li>
                        <li>
                  ...
                  {/* comment-reply */}
                  <div className='le__comment-reply-area le__form-box mb-30'>
                    <form action='#'>
                      <h4>Add a Review</h4>
                      <div className='mb-30'>
                      ...
                      <div className='input-item input-item-textarea le__custom-icon'>
                        <textarea placeholder='Type your comments....' defaultValue={""} />
                      </div>
                      <div className='input-item input-item-name le__custom-icon'>
                        <input type='text' placeholder='Type your name....' />
                      </div>
                      <div className='input-item input-item-email le__custom-icon'>
                        <input type='email' placeholder='Type your email....' />
                      </div>
                      <div className='input-item input-item-website le__custom-icon'>
                ...
                <div className='row'>
                  ...
                  <div className='col-xl-6 col-sm-6 col-12 go-top'>
                    <div className='le__product-item le__product-item-4 le__product-item-5 text-center---'>
                      ...
                      <div className='product-info'>
                        ...
                        <ul className='le__list-item-2--- le__list-item-2-before--- le__plot-brief'>
                          <li>
                            <span>3 </span>
                            Bedrooms
                          </li>
            ...
            <div className='col-lg-4'>
              <aside className='sidebar le__shop-sidebar le__right-sidebar---'>
                {/* Author Widget */}
                <div className='widget le__author-widget'>
                  <div className='le__author-widget-inner text-center'>
                ...
                {/* Search Widget */}
                <div className='widget le__search-widget'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Search Objects</h4>
                  <form action='#'>
                ...
                {/* Form Widget */}
                <div className='widget le__form-widget'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Drop Messege For Book</h4>
                  <form action='#'>
                ...
                <div className='widget le__top-rated-product-widget go-top'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Top Rated Product</h4>
                  <ul>
                    <li>
                ...
                <div className='widget le__menu-widget le__menu-widget-2--- le__menu-widget-2-color-2---'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Top Categories</h4>
                  <ul className='go-top'>
                    <li>
                      <Link to='/blog-grid'>
                ...
                <div className='widget le__popular-product-widget'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Popular Properties</h4>
                  <div className='row le__popular-product-widget-active slick-arrow-1'>
                    {/* le__product-item */}
                ...
                {/* Popular Post Widget */}
                <div className='widget le__popular-post-widget go-top'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Leatest Blogs</h4>
                  <ul>
                    <li>
                ...
                {/* Social Media Widget */}
                <div className='widget le__social-media-widget'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Follow us</h4>
                  <div className='le__social-media-2'>
                    <ul>
                      <li>
                        <a href='#' title='Facebook'>
                          <i className='fab fa-facebook-f' />
                ...
                {/* Tagcloud Widget */}
                <div className='widget le__tagcloud-widget go-top'>
                  <h4 className='le__widget-title le__widget-title-border-2'>Popular Tags</h4>
                  <ul>
                    <li>
                ...
                {/* Banner Widget */}
                <div className='widget le__banner-widget d-none go-top'>
                  <Link to='/shop'>
