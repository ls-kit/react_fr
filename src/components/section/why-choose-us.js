...
class WhyChooseUs extends Component {
  render() {
    ...
    return (
      <div className='le__feature-area section-bg-2 pt-115 pb-90'>
        <div className='container'>
          ...
          <div className='row justify-content-center'>
            <div className='col-xl-4 col-sm-6 col-12'>
              <div className='le__feature-item le__feature-item-7 le__feature-item-7-color-white'>
                <div className='le__feature-icon-title'>
