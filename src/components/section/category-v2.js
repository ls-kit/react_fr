...
class CategoryV2 extends Component {
  render() {
    ...
    return (
      <div className='le__category-area le__product-gutter section-bg-1--- pt-115 pb-70'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <div className='section-title-area le__section-title-2--- text-center'>
                <h6 className='section-subtitle section-subtitle-2--- le__secondary-color'>Our Aminities</h6>
                <h1 className='section-title'>Building Aminities</h1>
              </div>
            </div>
          </div>
          <div className='row le__category-slider-active--- slick-arrow-1 justify-content-center go-top'>
            <div className='col-lg-3 col-md-4 col-sm-6 col-6'>
              <div className='le__category-item le__category-item-5 le__category-item-5-2 text-center---'>
                <Link to='/shop'>
                  ...
                  <span className='category-brief'>Enimad minim veniam quis no exercitation ullamco lab</span>
