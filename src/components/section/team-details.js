...
class TeamDetails extends Component {
  render() {
    ...
    return (
      <div className='le__team-details-area mb-120'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-4'>
              <div className='le__team-details-member-info text-center mb-40'>
                <div className='team-details-img'>
                  <img src={publicUrl + "assets/img/team/4.jpg"} alt='Team Member Image' />
                </div>
                <h2>Rosalina D. William</h2>
                <h6 className='text-uppercase le__secondary-color'>Property Seller</h6>
                <div className='le__social-media-3'>
                  <ul>
                    <li>
            ...
            <div className='col-lg-8'>
              <div className='le__team-details-member-info-details'>
                <p>
                ...
                <div className='row'>
                  <div className='col-lg-6'>
                    <div className='le__team-details-member-about'>
                      <ul>
                        <li>
                ...
                <p>
                  ...
                  aspernatur aut odit aut fugit, sed quia consequu ntur magni dolores eos qui ratione
                  voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet,
                  consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et
                  dolore magnam aliquam quaerat voluptatem.
                </p>
                <div className='row le__custom-gutter mt-50 mb-20'>
                  <div className='col-xl-4 col-sm-6 col-12 go-top'>
                    <div className='le__feature-item le__feature-item-6 text-center'>
                      ...
                      <div className='le__feature-info'>
                        ...
                        {/* <a class="le__service-btn" href="service.html">Read More</a> */}
                  ...
                  <div className='col-xl-4 col-sm-6 col-12'>
                    <div className='le__feature-item le__feature-item-6 text-center active'>
                      <div className='le__feature-icon'>
                        <span>
                          <i className='icon-mechanic' />
                        </span>
                      </div>
                      <div className='le__feature-info go-top'>
                        <h4>
                ...
                <div className='le__form-box contact-form-box box-shadow white-bg mt-50'>
