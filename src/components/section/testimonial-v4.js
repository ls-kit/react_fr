...
class TestimonialV4 extends Component {
  render() {
    ...
    return (
      <div
        className='le__testimonial-area bg-image pt-115 pb-70'
          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className='section-title-area le__section-title-2--- text-center---'>
                <h6 className='section-subtitle section-subtitle-2 le__secondary-color'>Testimonials</h6>
                <h1 className='section-title'>Clients Feedbacks</h1>
              </div>
            </div>
          </div>
          <div className='row le__testimonial-slider-2-active slick-arrow-3'>
            <div className='col-lg-12'>
              <div className='le__testimonial-item le__testimonial-item-3'>
                ...
                <div className='le__testimoni-info'>
                  <p>
                    Lorem ipsum ctetur elit, sed do eius mod tempor incididunt ut labore et dolore magna
                    aliqua.{" "}
                  </p>
