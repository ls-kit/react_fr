...
class AboutV5 extends Component {
  render() {
    ...
    return (
      <div className='le__about-us-area pb-115 go-top'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-5 align-self-center'>
              <div className='about-us-img-wrap le__img-shape-left  about-img-left'>
            ...
            <div className='col-lg-7 align-self-center'>
              <div className='about-us-info-wrap'>
                ...
                <div className='btn-wrapper animated'>
                  <Link to='/about' className='theme-btn-1 btn btn-effect-1 text-uppercase'>
                    About Us
                  </Link>
                </div>
              </div>
