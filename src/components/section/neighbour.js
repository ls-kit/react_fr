    ...
    return (
      <div className='neighbour-area section-bg-1 pt-118 pb-120'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <div className='section-title-area le__section-title-2--- text-center---'>
                <h6 className='section-subtitle section-subtitle-2--- le__secondary-color'>
                  Explore Neighbour
                </h6>
          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className='le__neighbour-tab-wrap'>
                <div className='le__tab-menu le__tab-menu-3--- le__tab-menu-4 le__tab-menu-top-right-- text-uppercase--- text-center'>
                  <div className='nav'>
                    <a className='active show' data-bs-toggle='tab' href='#liton_tab_4_1'>
                ...
                <div className='tab-content'>
                  <div className='tab-pane fade active show' id='liton_tab_4_1'>
                    <div className='le__neighbour-tab-content-inner'>
                      <div className='row'>
                        ...
                        <div className='col-lg-4'>
                          <div className='le__search-by-place-item neighbour-apartments-item'>
                            ...
                            <div className='search-by-place-info go-top'>
                              <h4>
                                <Link to='/product-details'>Shopping Center</Link>
                              </h4>
                              <label>
                                <span className='le__secondary-color'>1,500m </span>/ 21 min. walk
                              </label>
                              <div className='search-by-place-brief'>
                                <p>
                                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                  tempor incididunt ut labore Enim ullamco laboris.
                                </p>
                              </div>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-lg-4'>
                          <div className='le__search-by-place-item neighbour-apartments-item'>
                            ...
                            <div className='search-by-place-info go-top'>
                              <h4>
                                <Link to='/product-details'>Medical Hospital</Link>
                              </h4>
                              <label>
                                <span className='le__secondary-color'>1,500m </span>/ 21 min. walk
                              </label>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-lg-4'>
                          <div className='le__search-by-place-item neighbour-apartments-item'>
                            ...
                            <div className='search-by-place-info go-top'>
                              <h4>
                                <Link to='/product-details'>Children Playland</Link>
                              </h4>
                              <label>
                                <span className='le__secondary-color'>1,500m </span>/ 21 min. walk
                              </label>
              ...
              <div className='le__faq-inner le__faq-inner-2 le__faq-inner-3'>
                <div className='row'>
                    ...
                    <div id='accordion_2'>
                      ...
                      <div className='card'>
                        ...
                        <div id='faq-item-2-2' className='collapse show---' data-bs-parent='#accordion_2'>
                          <div className='card-body'>
                            <div className='le__video-img alignleft'>
                              <img src={publicUrl + "assets/img/bg/17.jpg"} alt='video popup bg image' />
                              <a
                                className='le__video-icon-2 le__video-icon-2-small le__video-icon-2-border----'
