...
class ProductSliderV3 extends Component {
  render() {
    ...
    return (
      <div
        className='le__search-by-place-area section-bg-1 before-bg-top--- bg-image-top--- pt-115 pb-70'
          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className='section-title-area le__section-title-2--- text-center'>
                <h6 className='section-subtitle section-subtitle-2 le__secondary-color'>Area Properties</h6>
                <h1 className='section-title'>Properties By Location</h1>
              </div>
            </div>
          </div>
          <div className='row le__search-by-place-slider-1-active slick-arrow-1 go-top'>
            <div className='col-lg-4'>
              <div className='le__search-by-place-item'>
