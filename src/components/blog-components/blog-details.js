...
class BlogDetails extends Component {
  render() {
    ...
    return (
      <div className='le__page-details-area le__blog-details-area mb-120'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-8'>
              <div className='le__blog-details-wrap'>
                <div className='le__page-details-inner le__blog-details-inner'>
                  ...
                  <blockquote>
                    <h6 className='le__secondary-color mt-0'>BY HETMAYAR</h6>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur expedita velit
                    laboriosam est sint laborum eos assumenda, quam voluptatem adipisci, reprehenderit ut
                    nobis blanditiis perspiciatis!
                  </p>
                  <div className='row'>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa, amet, fuga omnis eligendi
                    sed cupiditate molestias enim autem animi est tempore ipsa corporis. Recusandae, quia.
                  </p>
                </div>
                {/* blog-tags-social-media */}
                <div className='le__blog-tags-social-media mt-80 row'>
                  <div className='le__tagcloud-widget col-lg-8 go-top'>
                    <h4>Releted Tags</h4>
                    <ul>
                      <li>
                  ...
                  <div className='le__social-media text-right text-end col-lg-4'>
                    <h4>Social Share</h4>
                    <ul>
                      <li>
                ...
                <hr />
                {/* prev-next-btn */}
                <div className='le__prev-next-btn row mb-50'>
                  <div className='blog-prev col-lg-6'>
                    <h6>Prev Post</h6>
                    <h3 className='le__blog-title'>
                      <Link to='#'>Tips On Minimalist</Link>
                    </h3>
                  </div>
                ...
                <div className='related-post-area mb-50'>
                  ...
                  <div className='row'>
                    <div className='col-md-6'>
                      {/* Blog Item */}
                      <div className='le__blog-item le__blog-item-6'>
                        <div className='le__blog-img'>
                          <Link to='/blog-details'>
                            <img src={publicUrl + "assets/img/blog/blog-details/11.jpg"} alt='Image' />
                          </Link>
                        </div>
                        <div className='le__blog-brief'>
                          <div className='le__blog-meta'>
                            <ul>
                              <li className='le__blog-date le__secondary-color'>
                                <i className='far fa-calendar-alt' />
                                June 22, 2020
                              </li>
                            </ul>
                          ...
                          <h3 className='le__blog-title'>
                            <Link to='/blog-details'>A series of iOS 7 inspire vector icons sense.</Link>
                          </h3>
                    ...
                    <div className='col-md-6'>
                      ...
                      <div className='le__blog-item le__blog-item-6'>
                        <div className='le__blog-img'>
                          <Link to='/blog-details'>
                            <img src={publicUrl + "assets/img/blog/blog-details/12.jpg"} alt='Image' />
                          </Link>
                        </div>
                        <div className='le__blog-brief'>
                          <div className='le__blog-meta'>
