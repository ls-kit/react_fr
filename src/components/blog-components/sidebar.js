  ...
  render() {
    ...
    return (
      <div className='col-lg-4 go-top'>
        <aside className='sidebar-area blog-sidebar le__right-sidebar'>
          {/* Author Widget */}
          <div className='widget le__author-widget'>
            <div className='le__author-widget-inner text-center'>
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis distinctio, odio, eligendi
          ...
          <div className='widget le__top-rated-product-widget'>
              ...
              <li>
                <div className='top-rated-product-item clearfix go-top'>
                  ...
                  <div className='top-rated-product-info'>
                    ...
                    <h6>
                      <Link to='/product-details'>Luxury House In Greenville </Link>
                    </h6>
          ...
          <div className='widget le__menu-widget le__menu-widget-2--- le__menu-widget-2-color-2--- go-top'>
          ...
          {/* Popular Post Widget */}
          <div className='widget le__popular-post-widget'>
          ...
          <div className='widget le__popular-post-widget le__twitter-post-widget'>
            <h4 className='le__widget-title le__widget-title-border-2'>Twitter Feeds</h4>
            <ul>
              <li>
                <div className='popular-post-widget-item clearfix'>
                  <div className='popular-post-widget-img'>
