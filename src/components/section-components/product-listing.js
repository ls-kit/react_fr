...
class ProductListingV1 extends Component {
  render() {
    ...
    return (
      <div>
        <div className='le__product-slider-area le__product-gutter pt-115 pb-70'>
          <div className='container'>
            <div className='row'>
              <div className='col-lg-12'>
                <div className='section-title-area le__section-title-2--- text-center'>
                  <h6 className='section-subtitle section-subtitle-2 le__secondary-color'>Property</h6>
                  <h1 className='section-title'>Latest Listings</h1>
                </div>
              </div>
            </div>
            <div className='row le__product-slider-item-three-active--- slick-arrow-1'>
              {/* le__product-item */}
