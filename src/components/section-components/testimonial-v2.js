...
class TestimonialV2 extends Component {
  render() {
    ...
    return (
      <div
        className='le__testimonial-area section-bg-1--- bg-image-top pt-115 pb-65'
      ...
      >
        <div className='container'>
          ...
          <div className='row le__testimonial-slider-6-active slick-arrow-3'>
            <div className='col-lg-4'>
              <div className='le__testimonial-item le__testimonial-item-7 le__testimonial-item-8'>
                <div className='le__testimoni-info'>
                  <div className='le__testimoni-author-ratting'>
                    ...
                    <div className='le__testimoni-rating'>
