...
class Gallery extends Component {
  render() {
    ...
    return (
      <div className='le__img-slider-area'>
        <div className='container-fluid'>
          <div className='row le__image-slider-4-active slick-arrow-1 slick-arrow-1-inner le__no-gutter-all'>
            <div className='col-lg-12'>
              <div className='le__img-slide-item-4'>
                ...
                <div className='le__img-slide-info'>
                  <div className='le__img-slide-info-brief gp-top'>
                    <h6>Heart of NYC</h6>
                    <h1>
                      <Link to='/portfolio-details'>Manhattan </Link>
                    </h1>
                  </div>
              ...
              <div className='le__img-slide-item-4'>
                ...
                <div className='le__img-slide-info'>
                  <div className='le__img-slide-info-brief gp-top'>
                    <h6>The Best City</h6>
                    <h1>
                      <Link to='/portfolio-details'>Jersey City</Link>
                    </h1>
                  </div>
                  <div className='btn-wrapper go-top'>
                    <Link to='/portfolio-details' className='btn theme-btn-1 btn-effect-1 text-uppercase'>
              ...
              <div className='le__img-slide-item-4'>
                ...
                <div className='le__img-slide-info'>
                  <div className='le__img-slide-info-brief gp-top'>
                    ...
                    <h1>
                      <Link to='/portfolio-details'>Queens </Link>
                    </h1>
                  </div>
                  <div className='btn-wrapper go-top'>
                    <Link to='/portfolio-details' className='btn theme-btn-1 btn-effect-1 text-uppercase'>
              ...
              <div className='le__img-slide-item-4'>
                ...
                <div className='le__img-slide-info'>
                  <div className='le__img-slide-info-brief gp-top'>
                    ...
                    <h1>
                      <Link to='/portfolio-details'>Greenville</Link>
                    </h1>
                  </div>
                  <div className='btn-wrapper go-top'>
                    <Link to='/portfolio-details' className='btn theme-btn-1 btn-effect-1 text-uppercase'>
