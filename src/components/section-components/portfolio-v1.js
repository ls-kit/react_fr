...
class PortfolioV1 extends Component {
  render() {
    ...
    return (
      <div className='le__gallery-area mb-120'>
        <div className='container'>
          {/* (le__gallery-info-hide) Class for 'le__gallery-item-info' not showing */}
          <div className='le__gallery-active row le__gallery-style-2 le__gallery-info-hide---'>
            <div className='le__gallery-sizer col-1' />
            {/* gallery-item */}
            <div className='le__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12'>
              <div className='le__gallery-item-inner'>
                <div className='le__gallery-item-img'>
                  <a href={publicUrl + "assets/img/gallery/1.jpg"} data-rel='lightcase:myCollection'>
                    ...
                    <span className='le__gallery-action-icon'>
                      <i className='fas fa-search' />
                    </span>
                  </a>
                </div>
                <div className='le__gallery-item-info'>
                  <h4 className='go-top'>
            ...
            {/* gallery-item */}
            <div className='le__gallery-item filter_category_2 col-lg-4 col-sm-6 col-12'>
              <div className='le__gallery-item-inner'>
                <div className='le__gallery-item-img'>
                  <a href='#le__inline_description_1' data-rel='lightcase:myCollection'>
            ...
            {/* gallery-item */}
            <div className='le__gallery-item filter_category_1 col-lg-4 col-sm-6 col-12'>
              <div className='le__gallery-item-inner'>
                <div className='le__gallery-item-img'>
          ...
          <div id='le__inline_description_1' style={{ display: "none" }}>
            <h4 className='first'>This content comes from a hidden element on that page</h4>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam quis mi eu elit tempor facilisis
              id et neque. Nulla sit amet sem sapien. Vestibulum imperdiet porta ante ac ornare. Nulla et
              lorem eu nibh adipiscing ultricies nec at lacus. Cras laoreet ultricies sem, at blandit mi
              eleifend aliquam. Nunc enim ipsum, vehicula non pretium varius, cursus ac tortor.
            </p>
            <p>
              ...
              aliquam diam varius ac. Maecenas nisl nunc, molestie vitae eleifend vel.
            </p>
          </div>
