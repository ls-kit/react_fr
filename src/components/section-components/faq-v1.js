...
class FaqV1 extends Component {
  render() {
    ...
    return (
      <div className='le__faq-area mb-100'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-8'>
              <div className='le__faq-inner le__faq-inner-2'>
                <div id='accordion_2'>
                  {/* card */}
                  <div className='card'>
                    <h6
                    ...
                    <div id='faq-item-2-1' className='collapse' data-bs-parent='#accordion_2'>
                      <div className='card-body'>
                        <p>
                          ...
                          lacinia quis vel eros donec ac. Mauris sit amet massa vitae tortor. Quisque id diam
                          vel quam elementum pulvinar. Gravida in fermentum et sollicitudin ac orci phasellus.
                          Facilisis gravida neque convallis a cras semper. Non arcu risus quis varius quam
                          quisque id.
                        </p>
                      </div>
                    </div>
