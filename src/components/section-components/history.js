...
class History extends Component {
  render() {
    ...
    return (
      <div className='le__our-history-area pb-100'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <div className='le__our-history-inner'>
                <div className='le__tab-menu text-uppercase'>
                  <div className='nav'>
                    <a data-bs-toggle='tab' href='#liton_tab_2_1'>
                      1900
                    </a>
                    <a className='active show' data-bs-toggle='tab' href='#liton_tab_2_2'>
                      1940
                    </a>
                    <a data-bs-toggle='tab' href='#liton_tab_2_3'>
                      2000
                    </a>
                    <a data-bs-toggle='tab' href='#liton_tab_2_4'>
                      2010
                    </a>
                    <a data-bs-toggle='tab' href='#liton_tab_2_5'>
                      2021
                    </a>
                  </div>
                </div>
                      ...
                      <div className='row'>
                        <div className='col-lg-6 align-self-center'>
                          <div className='about-us-img-wrap about-img-left'>
                            ...
                            <div className='le__history-icon'>
                        ...
                        <div className='col-lg-6 align-self-center'>
                          <div className='about-us-info-wrap'>
                            ...
                            <p>
                              Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eius mod
                              tempor incididunt ut labore et dolore magna aliqua. consectetur adipis icing
                              elit, sed do eius mod t
                            </p>
                          </div>
                        </div>
                      </div>
