        ...
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              ...
              <div className='le__product-tab-area'>
                <div className='container'>
                  <div className='row'>
                    <div className='col-lg-4'>
                      <div className='le__tab-menu-list mb-50'>
                        <div className='nav'>
                    ...
                    <div className='col-lg-8'>
                      <div className='tab-content'>
                        <div className='tab-pane fade active show' id='ltn_tab_1_1'>
                          <div className='le__myaccount-tab-content-inner'>
                            <p>
                            ...
                            <p>
                              From your account dashboard you can view your <span>recent orders</span>, manage
                              your <span>shipping and billing addresses</span>, and{" "}
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_2'>
                          <div className='le__myaccount-tab-content-inner'>
                            {/* comment-area */}
                            <div className='le__comment-area mb-50'>
                              ...
                              <div className='le__form-box contact-form-box box-shadow white-bg'>
                                ...
                                <form id='contact-form' action='mail.php' method='post'>
                                  <div className='row'>
                                    ...
                                    <div className='col-md-6'>
                                      <div className='input-item input-item-phone le__custom-icon'>
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_4'>
                          <div className='le__myaccount-tab-content-inner'>
                            <p>The following addresses will be used on the checkout page by default.</p>
                            <div className='le__form-box'>
                              <form action='#'>
                                <div className='row mb-50'>
                                  <div className='col-md-6'>
                                    <label>First name:</label>
                                    <input type='text' name='le__name' />
                                  </div>
                                  <div className='col-md-6'>
                                    <label>Last name:</label>
                                    <input type='text' name='le__lastname' />
                                  </div>
                                  <div className='col-md-6'>
                                    <label>Display Name:</label>
                                    <input type='text' name='le__lastname' placeholder='Ethan' />
                                  </div>
                                  <div className='col-md-6'>
                                ...
                                <fieldset>
                                  ...
                                  <div className='row'>
                                    <div className='col-md-12'>
                                      ...
                                      <input type='password' name='le__name' />
                                      <label>New password (leave blank to leave unchanged):</label>
                                      <input type='password' name='le__lastname' />
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_5'>
                          <div className='le__myaccount-tab-content-inner'>
                            <div className='le__my-properties-table table-responsive'>
                              <table className='table'>
                                ...
                                <tbody>
                                  <tr>
                                    <td className='le__my-properties-img go-top'>
                                      <Link to='/product-details'>
                                        <img src={publicUrl + "assets/img/product-3/2.jpg"} alt='#' />
                                      </Link>
                                    </td>
                                    <td>
                                      <div className='le__my-properties-info'>
                                        <h6 className='mb-10 go-top'>
                                          <Link to='/product-details'>New Apartment Nice View</Link>
                                        </h6>
                                        <small>
                                          <i className='icon-placeholder' /> Brooklyn, New York, United States
                                        </small>
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_7'>
                          <div className='le__myaccount-tab-content-inner'>
                            ...
                            <div className='row'>
                              <div className='col-md-12'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='*Title (mandatory)' />
                                </div>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <textarea name='le__message' placeholder='Description' defaultValue={""} />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className='row'>
                              ...
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Yearly Tax Rate' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                            ...
                            <div className='row'>
                              ...
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Embed Video ID' />
                                </div>
                              </div>
                            </div>
                            <h6>Virtual Tour</h6>
                            <div className='input-item input-item-textarea le__custom-icon'>
                              <textarea name='le__message' placeholder='Virtual Tour:' defaultValue={""} />
                            </div>
                            <h6>Listing Location</h6>
                            <div className='row'>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='*Address' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Country' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='County / State' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='City' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Neighborhood' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Zip' />
                                </div>
                              </div>
                              <div className='col-lg-12'>
                            ...
                            <div className='row'>
                              ...
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Rooms (*only numbers)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Bedrooms (*only numbers)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                              ...
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Custom ID (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Garages (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Year Built (*numeric)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Garage Size (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Available from (*date)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Basement (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Extra Details (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Roofing (*text)' />
                                </div>
                              </div>
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                            ...
                            <div className='row'>
                              ...
                              <div className='col-md-6'>
                                <div className='input-item input-item-textarea le__custom-icon'>
                                  <input type='text' name='le__name' placeholder='Energy Index in kWh/m2a' />
                                </div>
                              </div>
                            </div>
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_8'>
                          <div className='le__myaccount-tab-content-inner'>
                            <div className='row'>
                              <div className='col-lg-12'>
                                <div className='le__checkout-inner'>
                                  <div className='le__checkout-single-content le__returning-customer-wrap'>
                                    <h5>
                                      Returning customer?{" "}
                                      <a
                                        className='le__secondary-color'
                                        href='#le__returning-customer-login'
                                    ...
                                    <div
                                      id='le__returning-customer-login'
                                      className='collapse le__checkout-single-content-info'
                                    >
                                      <div className='ltn_coupon-code-form le__form-box'>
                                  ...
                                  <div className='le__checkout-single-content le__coupon-code-wrap'>
                                    <h5>
                                      Have a coupon?{" "}
                                      <a
                                        className='le__secondary-color'
                                        href='#le__coupon-code'
                                        data-toggle='collapse'
                                      >
                                    ...
                                    <div
                                      ...
                                      className='collapse le__checkout-single-content-info'
                                    >
                                      <div className='le__coupon-code-form'>
                                  ...
                                  <div className='le__checkout-single-content mt-50'>
                                    <h4 className='title-2'>Billing Details</h4>
                                    <div className='le__checkout-single-content-info'>
                                      <form action='#'>
                                        <h6>Personal Information</h6>
                                        <div className='row'>
                                          <div className='col-md-6'>
                                            <div className='input-item input-item-name le__custom-icon'>
                                              <input type='text' name='le__name' placeholder='First name' />
                                            </div>
                                          </div>
                                          <div className='col-md-6'>
                                            <div className='input-item input-item-name le__custom-icon'>
                              ...
                              <div className='col-lg-6'>
                                <div className='le__checkout-payment-method mt-50'>
                                  <h4 className='title-2'>Payment Method</h4>
                                  <div id='checkout_accordion_1'>
                                    {/* card */}
                                    <div className='card'>
                                      <h5
                                        className='collapsed le__card-title'
                                        data-toggle='collapse'
                                    ...
                                    <div className='card'>
                                      ...
                                      >
                                        PayPal{" "}
                                        <img src={publicUrl + "assets/img/icons/payment-3.png"} alt='#' />
                                      </h5>
                                      <div
                                        id='faq-item-2-3'
                                        className='collapse'
                                  ...
                                  <div className='le__payment-note mt-30 mb-30'>
                                    <p>
                        ...
                        <div className='tab-pane fade' id='ltn_tab_1_9'>
                          <div className='le__myaccount-tab-content-inner'>
                            <div className='account-login-inner'>
                              <form action='#' className='le__form-box contact-form-box'>
