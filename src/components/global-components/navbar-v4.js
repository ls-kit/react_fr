...
class NavbarV3 extends Component {
  render() {
    ...
    return (
      <div>
        <header className='le__header-area le__header-5 le__header-logo-and-mobile-menu-in-mobile le__header-logo-and-mobile-menu le__header-transparent gradient-color-2'>
          {/* le__header-top-area start */}
          <div className='le__header-top-area top-area-color-white d-none'>
          ...
          {/* le__header-top-area end */}
          {/* le__header-middle-area start */}
          <div className='le__header-middle-area le__header-sticky le__sticky-bg-black'>
            <div className='container'>
              <div className='row'>
                <div className='col'>
                ...
                <div className='col--- le__header-options le__header-options-2 '>
                  {/* Mobile Menu Button */}
