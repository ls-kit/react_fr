  ...
  render() {
    ...
    return (
      <div>
        ...
        <header className='le__header-area le__header-3 section-bg-6---'>
          {/* le__header-middle-area start */}
          <div className='le__header-middle-area'>
            <div className='container'>
              <div className='row'>
                ...
                <div className='col'>
                  {/* header-options */}
                  <div className='le__header-options'>
                    <ul>
                      <li className='d-none'>
                        {/* le__currency-menu */}
                        <div className='le__drop-menu le__currency-menu'>
                          <ul>
                            <li>
                      ...
                      <li className='d-none'>
                        {/* user-menu */}
                        <div className='le__drop-menu user-menu'>
                          <ul>
                            <li>
                              <a href='#'>
                      ...
                      <li>
                        ...
                        <div className='mini-cart-icon mini-cart-icon-2'>
                          <a href='#le__utilize-cart-menu' className='le__utilize-toggle'>
                            <span className='mini-cart-icon'>
                              <i className='icon-shopping-cart' />
                              <sup>2</sup>
                            </span>
                            <h6>
                              <span>Your Cart</span> <span className='le__secondary-color'>$89.25</span>
                            </h6>
                          </a>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className='mobile-menu-toggle d-lg-none'>
                          <a href='#le__utilize-mobile-menu' className='le__utilize-toggle'>
          ...
          {/* le__header-middle-area end */}
          {/* header-bottom-area start */}
          <div className='header-bottom-area le__border-top le__header-sticky  le__sticky-bg-white le__primary-bg---- menu-color-white---- d-none d-lg-block'>
            <div className='container'>
              <div className='row'>
        ...
        <div id='le__utilize-cart-menu' className='le__utilize le__utilize-cart-menu'>
          <div className='le__utilize-menu-inner le__scrollbar'>
            <div className='le__utilize-menu-head'>
              <span className='le__utilize-menu-title'>Cart</span>
              <button className='le__utilize-close'>×</button>
            </div>
            <div className='mini-cart-product-area le__scrollbar'>
        ...
        <div id='le__utilize-mobile-menu' className='le__utilize le__utilize-mobile-menu'>
          <div className='le__utilize-menu-inner le__scrollbar'>
            <div className='le__utilize-menu-head'>
              <div className='site-logo'>
                <Link to='/'>
            ...
            <div className='le__utilize-menu-search-form'>
            ...
            <div className='le__utilize-menu'>
              <ul>
                <li>
                  <a href='#'>Home</a>
            ...
            <div className='le__utilize-buttons le__utilize-buttons-2'>
              <ul>
                <li>
