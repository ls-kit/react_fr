  ...
  render() {
    ...
    return (
      <div>
        <header
          className={
            "le__header-area le__header-5 le__header-logo-and-mobile-menu-in-mobile le__header-logo-and-mobile-menu le__header-transparent--- gradient-color-4--- " +
            CustomClass
          }
        >
          {/* le__header-top-area start */}
          <div className='le__header-top-area d-none'>
